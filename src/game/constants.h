...
constexpr float  visual_pitch_gain      = 0.25f;   // radians of pitch per pixel/sec of vertical steering
constexpr float  visual_pitch_max       = 0.35f;   // radians (~20°) maximum pitch angle
constexpr float  visual_pitch_spring    = 5.0f;    // spring rate for pitch return (rad/sec²/rad)
